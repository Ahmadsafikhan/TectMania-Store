            ...
            >
              ...
              <div className="flex flex-col justify-between md:w-2/4 items-center">
                <div className="md:w-2/4 md:pl-4">
                  <Link to={`/products/${item._id}`} className="text-blue-500">
                    {item.name}
                  </Link>
                </div>
                <div className="md:w-1/4 mt-2 md:mt-0 text-center md:text-left">${item.price}</div>
              </div>
              <div className="md:w-1/4 mt-2 md:mt-0">
                <div className="flex items-center justify-center md:justify-start">
                  ...
                  <span className="mx-2 text-xl md:text-base">{item.qty}</span>
                  <button
                    type="button"
