...
const ProductDetail = () => {
  ...
  const submitHandler = async (e) => {
    ...
    // Your review submission code here using Axios

    try {
      // Submit review using Axios
    ...
    {loading ? (
      ...
      <>
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="mt-4">
            <h2 className="text-2xl font-semibold">Write a Customer Review</h2>
            ...
            {userInfo ? (
              ...
              <Message>
                Please <Link to={"/login"} className="font-bold">sign in</Link> to write a review
              </Message>
            )}
          </div>
        </div>
